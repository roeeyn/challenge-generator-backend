...
#
#     PHX_SERVER=true bin/challenge_generator start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :challenge_generator, ChallengeGeneratorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "challenge-generator-backend.herokuapp.com"
